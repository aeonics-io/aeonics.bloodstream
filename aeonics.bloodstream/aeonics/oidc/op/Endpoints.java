...
public class Endpoints 
{
	...
	{
		router.addRelation("endpoints", wellknown);
		router.addRelation("endpoints", jwks);
		router.addRelation("endpoints", authorize_get);
		router.addRelation("endpoints", authorize_post);
		router.addRelation("endpoints", token);
		router.addRelation("endpoints", login);
		router.addRelation("endpoints", otp);
		router.addRelation("endpoints", consent);
