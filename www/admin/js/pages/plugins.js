...
{
	ae.require('Page', 'Node', 'Ajax', 'Translator', 'Notify', 'Modal', 'page.plugins.css').then(([Page, Node, Ajax, Translator, Notify, Modal]) =>
	{
		var page = new Page();
		Object.assign(page, 
		{
			...
			undeploy: function(module, file)
			{
				var self = this;
				Modal.confirm(Translator.get('plugins.remove.confirm', ae.safeHtml(module)), [Translator.get('remove'), Translator.get('cancel')]).then((index) =>
				{
					if( index > 0 ) return;
