...
class EsgPage extends Page
{
	async show()
	{
		this.dom.classList.add('esg');
		document.body.querySelectorAll('nav li').forEach(e => { if( e.dataset.link == 'esg') e.classList.add('selected'); else e.classList.remove('selected'); });
